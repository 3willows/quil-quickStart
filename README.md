...
Source: http://quil.info/ "Getting started" "ClojureScript" 
...
- project at London Clojurians
- config issue with figwheel, work around with ```lein cljsbuild auto``` and then running index.html with Live Server
